...
namespace Spoonity\Entity\Abstraction\Oauth;
...
use Spoonity\Entity\Oauth\UserTokenType;
use Spoonity\Entity\User;

/**
 * Class BaseUserToken
 * @package Spoonity\Entity\Abstraction\Oauth
 */
abstract class BaseUserToken implements AccessTokenEntityInterface, RefreshTokenEntityInterface, AuthCodeEntityInterface
{
    ...
    public function getRedirectUri()
    {
         ...
         */
        return 'https://dashboard.spoonity.com/oauth/redirect';
    }
    ...
    public function convertToJwt(): Plain
    {
        ...
        return $this->jwtConfiguration->builder()
            ->permittedFor(($this->getClient()) ? $this->getClient()->getClientId() : 'https://api.spoonity.com')
